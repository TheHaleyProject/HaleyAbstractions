...
namespace Haley.Models {
    public class OSSClientInfo : OSSDirectory {
        ...
        public OSSClientInfo(string display_name) :this (display_name,null) { }
        public OSSClientInfo(string display_name,string password) : this(display_name, password, null, null) { }
        public OSSClientInfo(string display_name,string password, string signingkey,string encryptkey) { 
