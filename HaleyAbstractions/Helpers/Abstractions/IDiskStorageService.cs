...
namespace Haley.Abstractions {
    public interface IDiskStorageService : IObjectStorageService {
        ...
        Task<IFeedback> RegisterModule(OSSName input, OSSName client_input, OSSControlMode content_control = OSSControlMode.None, OSSParseMode content_pmode = OSSParseMode.Parse); //If a client is not registered, we register it against "Default"
