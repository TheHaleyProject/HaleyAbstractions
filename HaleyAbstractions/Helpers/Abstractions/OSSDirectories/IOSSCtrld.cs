...
namespace Haley.Models {
    public class IOSSCtrld :IOSSInfo {
        ...
        public IOSSCtrld():this(null) { }
        public IOSSCtrld(string name, OSSControlMode control = OSSControlMode.None, OSSParseMode parse = OSSParseMode.Parse) {
